...
public class OneTimePassword {
    ...
    public static String getRandomNumber(int size) {
        ...
        try {
            SecureRandom number = SecureRandom.getInstance(CustomConstants.ALGORITHM_NAME);
    ...
    public static byte[] hmacShaGenerate(byte[] keyBytes, byte[] text) throws NoSuchAlgorithmException, InvalidKeyException {
        Mac hmacSha;
        try {
            hmacSha = Mac.getInstance(CustomConstants.ALGORITHM_HMAC);
        } catch (NoSuchAlgorithmException nsa) {
            hmacSha = Mac.getInstance(CustomConstants.ALGORITHM_HMAC_SHA);
        }
